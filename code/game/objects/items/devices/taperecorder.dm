/obj/item/device/taperecorder
	...
	var/obj/item/device/tape/mytape = new /obj/item/device/tape/random()
	var/open_panel = 0
	var/datum/wires/taperecorder/wires
	var/canprint = 1
...
/obj/item/device/taperecorder/attackby(obj/item/I, mob/user)
	...
	else if(istype(I, /obj/item/weapon/card/emag) && mytape && !mytape.emagged)
		mytape.emagged = 1
		recording = 0
		user << "<span class='warning'>PZZTTPFFFT</span>"
		update_icon()

	else if(open_panel && IsWiresHackingTool(I))
		wires.Interact(user)
...
/obj/item/device/taperecorder/verb/play()
	...
	if(mytape && mytape.emagged)
		T.visible_message("<font color=Maroon><B>Tape Recorder</B>: Self-destructing...</font>")
		spawn(10)
			explode()
...
/obj/item/device/taperecorder/verb/print_transcript()
	...
	if(mytape.emagged)
		var/turf/T = get_turf(src)
		T.visible_message("<font color=Maroon><B>Tape Recorder</B>: Access denied.</font>")
		T.visible_message("<font color=Maroon><B>Tape Recorder</B>: Self-destructing...</font>")
		spawn(10)
			explode()
		return
