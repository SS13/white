...
proc/get_airlock_wires_text()
	var/text = "<BR>Airlock wires:"

	text += "<BR>Main power wires are [GetWireColorByFlag(AIRLOCK_WIRE_MAIN_POWER1, /obj/machinery/door/airlock)] "
	text += "and [GetWireColorByFlag(AIRLOCK_WIRE_MAIN_POWER2, /obj/machinery/door/airlock)]."
	text += "<BR>Backup power wires are [GetWireColorByFlag(AIRLOCK_WIRE_BACKUP_POWER1, /obj/machinery/door/airlock)] "
	text += "and [GetWireColorByFlag(AIRLOCK_WIRE_BACKUP_POWER2, /obj/machinery/door/airlock)]."
	text += "<BR>Bolts wire is [GetWireColorByFlag(AIRLOCK_WIRE_DOOR_BOLTS, /obj/machinery/door/airlock)]."
	text += "<BR>Bolts light wire is [GetWireColorByFlag(AIRLOCK_WIRE_LIGHT, /obj/machinery/door/airlock)]."
	text += "<BR>ID scanner wire is [GetWireColorByFlag(AIRLOCK_WIRE_IDSCAN, /obj/machinery/door/airlock)]."
	text += "<BR>AI control wire is [GetWireColorByFlag(AIRLOCK_WIRE_AI_CONTROL, /obj/machinery/door/airlock)]."
	text += "<BR>Access wire is [GetWireColorByFlag(AIRLOCK_WIRE_OPEN_DOOR, /obj/machinery/door/airlock)]."
	text += "<BR>Safety wire is [GetWireColorByFlag(AIRLOCK_WIRE_CRUSH, /obj/machinery/door/airlock)]."
	text += "<BR>Timing system wire is [GetWireColorByFlag(AIRLOCK_WIRE_SPEED, /obj/machinery/door/airlock)]."
	text += "<BR>Electrification wire is [GetWireColorByFlag(AIRLOCK_WIRE_ELECTRIFY, /obj/machinery/door/airlock)]."
