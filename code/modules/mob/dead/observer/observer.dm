...
/mob/dead/observer/verb/hat()
	...
	var/list/hats = list("beret", "wizard", "witch", "redwizard", "marisa", "wizard-fake", "deathsquad", "riot", "bio", "nursehat", "santahat", "detective", "paper", "hoscap", "pirate", "security", "viking", "headmetroid", "metroid", "petehat", "kitty", "bunny", "xenom", "xenos", "sombrero", "wardenberet", "officerberet", "hosberet", "hardhat0_pumpkin", "xmashat", "cardborg_h", "chickenhead", "helmlaw", "Bald")
